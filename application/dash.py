...
df = entidades_s[entidades_s.NOM_ZM == "Guadalajara"]
 ...
 html.Br(),
    ...
    dbc.Row(
           [   #mapa de la entidad 
            ...
            dbc.Col(dbc.Button(dbc.CardImg(src="https://github.com/fdealbam/0entrada/blob/1b4035d7f8e8561f02b23b9827578bd64d0b26b3/1zmguadalajara.png?raw=true"),
